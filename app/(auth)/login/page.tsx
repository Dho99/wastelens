    ...
    <div className="flex min-h-screen items-center justify-center px-4 bg-white/80 backdrop-blur py-8">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-xl text-neutral-950 mb-2">Lingkungan bersih dimulai dari lingkunganmu</p>
          <p className="text-neutral-700">Laporkan sampah, pantau penanganannya, dan dapatkan reward atas kontribusimu.</p>
        </div>
