    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex gap-2 rounded-lg bg-neutral-100 p-1">
        <button
          ...
          className={`flex-1 rounded-md px-3 py-2 text-sm font-medium transition-colors ${
            mode === "manual" ? "bg-white shadow-sm" : "text-neutral-500 hover:text-neutral-700"
          }`}
        >
          Input Manual
        </button>
        <button
          ...
          className={`flex-1 rounded-md px-3 py-2 text-sm font-medium transition-colors ${
            mode === "upload" ? "bg-white shadow-sm" : "text-neutral-500 hover:text-neutral-700"
          }`}
        >
          Upload Excel
        </button>
      ...
      {mode === "upload" && (
        <div className="space-y-4">
          ...
          >
            <svg className="mb-2 size-8 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {uploadResult && (
            <div className="rounded-xl border bg-white p-4">
              <p className="text-sm font-medium text-green-700">
                Berhasil: {uploadResult.inserted} produk ditambahkan
              </p>
