      ...
      <div className="grid grid-cols-2 gap-4">
        {products.map((prod) => {
          ...
          return (
            <div
              key={prod.id}
              className="bg-white border border-gray-100 rounded-[28px] p-3 flex flex-col justify-between shadow-sm"
            >
              {/* Image box */}
              ...
              <div className="flex items-center justify-between px-0.5">
                ...
                {/* Counter control pill */}
                <div className="bg-[#FFF0E6] border border-[#ffecd6] rounded-full p-1 flex items-center gap-2.5 shadow-sm">
                  {/* Minus button */}
                  <button
                    onClick={() => onRemoveProduct(prod.id)}
                    className="w-6 h-6 rounded-full bg-[#fbe7d5] hover:bg-[#ebd0b8] active:scale-90 flex items-center justify-center text-[#A05C2C] font-black text-xs transition-colors"
                  >
                    {/* mdi-minus */}
                  ...
                  {/* Quantity */}
                  <span className="text-xs font-black text-gray-800 select-none min-w-[8px] text-center">
                    {qty}
                  </span>
                  ...
                  <button
                    ...
                    className="w-6 h-6 rounded-full bg-[#287A38] hover:bg-[#20632d] active:scale-90 flex items-center justify-center text-white font-black text-xs transition-colors"
                  >
                    {/* mdi-plus */}
                    <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
        ...
        {/* Card 4: Segera Hadir placeholder */}
