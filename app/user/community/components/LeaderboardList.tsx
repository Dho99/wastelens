            ...
            <div className="px-5 py-8 text-center select-none space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-[11px] text-gray-400 font-semibold max-w-[240px] mx-auto leading-relaxed">
                        Koneksi internet bermasalah atau server sedang sibuk.
                            ...
                            <div className="flex items-center gap-0.5 mt-0.5 text-[9px] font-bold">
                                {entry.rankChange > 0 ? (
                                    ...
                                    <>
                                        ...
                                        <svg
                                            className="w-3.5 h-3.5 fill-current text-rose-600"
                                            viewBox="0 0 24 24"
                                        >
            ...
            {loading && (
                <div className="space-y-3 pt-1">
                    {[...Array(3)].map((_, i) => (
                        <div
                            key={i}
                            className="bg-white border border-gray-100 rounded-3xl p-4.5 shadow-sm flex items-center justify-between animate-pulse"
                        >
