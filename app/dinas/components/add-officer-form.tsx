        ...
        <main className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-5">
          <form onSubmit={submit} className="mx-auto max-w-[1160px]">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
              <div>
                <div className="flex items-center gap-2 text-xs font-semibold text-[#526158]">
                  <span>Petugas</span>
                  <span>›</span>
                  <span className="font-bold text-[#087529]">
                    Tambah Petugas Baru
                  </span>
                </div>
                ...
                <p className="mt-1 text-sm text-[#667169]">
                  Daftarkan personil lapangan baru ke dalam sistem operasional
                  WasteLens.
                </p>
              </div>
            ...
            <div className="mt-5 grid items-start gap-5 lg:grid-cols-[minmax(0,1.45fr)_minmax(320px,1fr)]">
              <div className="space-y-4">
                <section className="rounded-[22px] border border-[#bdcbbd] bg-white p-5">
                  <h2 className="flex items-center gap-3 text-lg font-extrabold">
                    <span className="grid size-10 place-items-center rounded-xl bg-[#2e8737] text-white">
                  ...
                  <div className="mt-5 grid gap-4 sm:grid-cols-2">
                    ...
                    <label className="text-sm font-semibold">
                      ...
                      <input
                        ...
                        required
                        pattern="FLD-[0-9]{4}"
                        title="Gunakan format FLD-XXXX"
                        placeholder="FLD-XXXX"
                        className={inputClass}
                      />
                    </label>
                    <label className="text-sm font-semibold">
                ...
                <section className="rounded-[22px] border border-[#bdcbbd] bg-white p-5">
                  <h2 className="flex items-center gap-3 text-lg font-extrabold">
                    <span className="grid size-10 place-items-center rounded-xl bg-[#b87800] text-white">
                  ...
                  <div className="mt-5 grid gap-4 sm:grid-cols-2">
                    ...
                    >
                      ...
                      <option>Supervisor Lapangan</option>
                      <option>Koordinator Wilayah</option>
                    </SelectField>
                  </div>
                </section>
              </div>
              ...
              <section className="rounded-[22px] border border-[#bdcbbd] bg-white p-5">
                <h2 className="flex items-center gap-3 text-lg font-extrabold">
                  <span className="grid size-10 place-items-center rounded-xl bg-[#bcebd1] text-[#47705b]">
                    <UploadCloud className="size-5" />
                  </span>
                  Verifikasi Identitas
                </h2>
                <p className="mt-5 text-xs text-[#526158]">
                  Unggah foto KTP atau profil resmi petugas (JPG/PNG, Maks.
                  5MB).
                </p>
                <input
                  ref={fileInput}
                ...
                <button
                  ...
                  onDrop={handleDrop}
                  className={`mt-4 flex h-[230px] w-full flex-col items-center justify-center overflow-hidden rounded-[22px] border-2 border-dashed transition ${dragging ? "border-[#087529] bg-[#eef9f2]" : "border-[#bdcbbd] bg-white"}`}
                >
                  {photo ? (
                    <span className="relative block size-full">
                      ...
                      />
                      <span className="absolute inset-x-0 bottom-0 bg-black/55 px-3 py-2 text-xs font-semibold text-white">
                        {fileName}
                      </span>
                    </span>
                  ) : (
                    <>
                      <span className="grid size-16 place-items-center rounded-full bg-[#e2eff6] text-[#087529]">
                        <Camera className="size-7" />
                      </span>
                      <span className="mt-4 text-base font-extrabold">
                        Tarik foto ke sini
                      </span>
                      <span className="mt-1 text-xs text-[#667169]">
                ...
                <div className="mt-4 flex gap-3 rounded-[20px] border border-[#bdcbbd] bg-[#f1f8fc] p-4">
                  <Info className="size-5 shrink-0 text-[#956100]" />
                  <p className="text-xs leading-5 text-[#667169]">
                    Pastikan wajah terlihat jelas dan ID Card tidak terpotong.
                    Verifikasi manual akan dilakukan oleh departemen HRD setelah
                    data dikirim.
                  </p>
                </div>
                <button
                ...
                <button
                  type="button"
                  onClick={() => router.push("/dinas/logistics")}
                  className="mt-3 flex h-11 w-full items-center justify-center gap-2 rounded-full border-2 border-red-600 text-sm font-extrabold text-red-600 hover:bg-red-50"
                >
                  <X className="size-4" />
                  Batalkan Pengisian
                </button>
        ...
        <div className="fixed inset-0 z-[90] grid place-items-center bg-slate-950/45 p-4 backdrop-blur-sm">
          ...
          >
            ...
            <p className="mt-2 text-sm text-[#667169]">
              Data petugas baru telah tersimpan dan menunggu verifikasi HRD.
            </p>
            <button
              type="button"
              onClick={() => router.push("/dinas/logistics")}
